  ...
  const teamMembers: TeamMember[] = [
    {
      ...
      name: "Jay Roja",
      title: "CEO & Founder",
      bio: "Digital marketing expert with over 8 years of experience driving growth for businesses.",
      image: "/team/ceo.jpg",
      social: {
        linkedin: "#",
        twitter: "#"
            ...
            >
              <div className="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow">
                ...
                <div className="p-6">
                  ...
                  {/* Social Links */}
                  <AnimateIn yOffset={20} duration={0.5} delay={0.1 * index + 0.25}>
