  ...
  const values = [
    {
      id: 1,
      title: "Transparency",
      description: "We provide clear reporting and honest communication every step of the way.",
      icon: (
    ...
    },
    {
      id: 2,
      title: "Innovation",
      description: "We stay ahead of industry trends and continuously improve our strategies.",
      icon: (
        <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      id: 6,
      title: "Integrity",
      description: "We do what's right, not what's easy, in all our business dealings.",
      icon: (
        <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
