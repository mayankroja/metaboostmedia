    ...
    <div className="bg-[#f8f9fa] p-6 rounded-lg">
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-start">
          ...
          <div>
            <h3 className="font-semibold text-[#0a2540]">Email</h3>
            <p className="text-[#666]">info@metaboostmedia.com</p>
            <p className="text-sm text-[#666]">We&apos;ll respond within 24 hours</p>
          </div>
        </div>
        ...
        <div className="flex items-start">
          ...
          <div>
            <h3 className="font-semibold text-[#0a2540]">Phone</h3>
            <p className="text-[#666]">+1 (555) 123-4567</p>
            <p className="text-sm text-[#666]">Mon-Fri from 9am to 5pm</p>
          </div>
        </div>
        ...
        <div className="flex items-start">
          ...
          <div>
            <h3 className="font-semibold text-[#0a2540]">Office</h3>
            <p className="text-[#666]">123 Digital Avenue</p>
            <p className="text-[#666]">Tech City, TC 12345</p>
          </div>
        </div>
      </div>
