      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1 md:col-span-2">
            ...
            <p className="text-[#00d4ff] text-sm md:text-base">
              Driving growth and dominating markets through results-driven
              digital strategies.
            </p>
          </div>
          ...
          <div className="lg:ml-8">
            ...
            <ul className="space-y-2">
              <li>
                <Link
                  href="/services#seo"
                  className="text-gray-300 hover:text-[#00d4ff] text-sm md:text-base"
                >
                  SEO & Content
                </Link>
              </li>
